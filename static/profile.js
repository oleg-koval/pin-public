...
var get_more_items, removeRePin, simplify_url;
...
}, $('#profile_lists_tabs').tabs(), $.offset = Array(), $.loading = Array(), $.column = Array(), $.pin_template = _.template($('#pin_template').html()), $.current_board = $('.profile_list_subtab:first').attr('boardid'), $('.profile_list_subtab').on('click', function(event) {
  var boardid, loading;
