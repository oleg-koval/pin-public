...
jQuery(function() {
  var clear_repin_form_notifications, disableMiddleMouseButtonScrolling, disableNormalScroll, disable_scroll, enable_scroll, get_more_items, show_error, simplify_url;
  $.ajaxSetup({
    cache: false
  });
